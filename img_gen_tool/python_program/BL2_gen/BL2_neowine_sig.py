...
class QLineEdit1(QLineEdit): 
    ...
    def dropEvent(self, event):
        ...
        if (urls and urls[0].scheme() == 'file'):
            ...
            BL2_signature_show.MyApp.dialog_open(self,push)
...
class QLineEdit2(QLineEdit): 
    ...
    def dropEvent(self, event):
        ...
        if (urls and urls[0].scheme() == 'file'):
            ...
            self.setText(filepath)
            push = (filepath, 'All Files (*)')
            BL2_signature_show.MyApp.get_key(self,push)
...
class Main(QDialog):
    ...
    def init_ui(self):        
        ...
        self.setWindowTitle("2nd BootLoader image generator")
        layout = QVBoxLayout()
    ...
    def buttonclicked(self):
        BL2_signature_show.MyApp.encrypt(BL2_signature_show.MyApp,Main.x)
        time.sleep(1)
        BL2_signature_show.MyApp.second_window(BL2_signature_show.MyApp)
