import sys
import time
import Firm_signature_show
from Firm_encryption import *
...
class QLineEdit1(QLineEdit): 
    ...
    def dropEvent(self, event):
        ...
        if (urls and urls[0].scheme() == 'file'):
            ...
            Firm_signature_show.MyApp.dialog_open(self,push)
...
class QLineEdit2(QLineEdit): 
    ...
    def dropEvent(self, event):
        ...
        if (urls and urls[0].scheme() == 'file'):
            ...
            self.setText(filepath)
            push = (filepath, 'All Files (*)')
            Firm_signature_show.MyApp.get_key(self,push)
...
class Main(QDialog):
    ...
    def init_ui(self):        
        ...
        self.setWindowTitle("Firmware image generator")
        layout = QVBoxLayout()
        ...
        self.btn1 = QPushButton('Input version', self)
    ...
    def buttonclicked(self):
        Firm_signature_show.MyApp.encrypt(Firm_signature_show.MyApp,Main.x)
        time.sleep(1)
        Firm_signature_show.MyApp.second_window(Firm_signature_show.MyApp)
