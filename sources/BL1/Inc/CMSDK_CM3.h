...
/* UART Registers*/
#define UART_BASE             ((volatile unsigned int *)(0x40006000))
#define UART_DR               ((volatile unsigned int *)(0x40006000 + 0x0000))
#define UART_RSR              ((volatile unsigned int *)(0x40006000 + 0x0004))
#define UART_ECR              ((volatile unsigned int *)(0x40006000 + 0x0004))
#define UART_FR               ((volatile unsigned int *)(0x40006000 + 0x0018))
#define UART_ILPR             ((volatile unsigned int *)(0x40006000 + 0x0020))
#define UART_IBRD             ((volatile unsigned int *)(0x40006000 + 0x0024))
#define UART_FBRD             ((volatile unsigned int *)(0x40006000 + 0x0028))
#define UART_LCR_H            ((volatile unsigned int *)(0x40006000 + 0x002C))
#define UART_CR               ((volatile unsigned int *)(0x40006000 + 0x0030))
#define UART_IFLS             ((volatile unsigned int *)(0x40006000 + 0x0034))
#define UART_IMSC             ((volatile unsigned int *)(0x40006000 + 0x0038))
#define UART_RIS              ((volatile unsigned int *)(0x40006000 + 0x003C))
#define UART_MIS              ((volatile unsigned int *)(0x40006000 + 0x0040))
#define UART_ICR              ((volatile unsigned int *)(0x40006000 + 0x0044))
#define UART_DMACR            ((volatile unsigned int *)(0x40006000 + 0x0048))
