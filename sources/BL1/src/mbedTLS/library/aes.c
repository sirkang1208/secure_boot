                    ...
                    unsigned int keybits )
{
	...
	#if MBED_AES_DEBUG
	printf("\r\n keybits: %d\r\n", keybits);
	print_bytes("mbedtls_aes_setkey_enc \r\n key01:", key, keybits/8);	
	#endif
#if MBEDTLS_ORG	
    switch( keybits )
    {
	...
	*RCM3_BUF_CTRL = 1;
	...
	switch( keybits )
    {
        case 128: key_length = 16; 
				  *RCM3_AES_CTRL = 0x03;
				  break;
        case 256: key_length = 32; 
				  *RCM3_AES_CTRL = 0x01;
				  break;
        default : return( MBEDTLS_ERR_AES_INVALID_KEY_LENGTH );
    }
	...
	*RCM3_RG_EEBUF_EN		=	0x01;	
	...
	for( i = 0; i < key_length; i++) data[i] = key[i];
                    ...
                    unsigned int keybits )
{
	...
	printf("\r\n keybits: %d\r\n", keybits);
	print_bytes("mbedtls_aes_setkey_dec \r\n key02:", key, keybits/8);	
	#endif
                                  ...
                                  unsigned char output[16] )
{
	...
	print_bytes("mbedtls_internal_aes_encrypt \r\n input:", input, 16);	
	#endif
	...
	*RCM3_RG_EEBUF_EN		=	0x01;
	...
	for( i = 0, j = 0; i < 16/4; i++) 
	{
		output[j+0] = (data32[i] >> 24) & 0xFF;
		output[j+1] = (data32[i] >> 16) & 0xFF;
		output[j+2] = (data32[i] >> 8) & 0xFF;
		output[j+3] = (data32[i]) & 0xFF;
                                  ...
                                  unsigned char output[16] )
{
	...
	print_bytes("mbedtls_internal_aes_decrypt \r\n input:", input, 16);	
	#endif
